...
#define malloc(x) _debug_malloc((size_t)(x), __FILE__, __LINE__)
#define realloc(x,y) _debug_realloc((void*)(x), (size_t)(y), __FILE__, __LINE__)
#define free(x) _debug_free((void*)(x), __FILE__, __LINE__)
